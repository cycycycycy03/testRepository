...
<%
	...
	// 로그인 되어있지 않으면 null (attribute에 loginUser라는 키값에 해당하는 데이터가 없음)
...
<style>
    ...
    .menu a {
        ...
        width: 100%;
        height: 100%;
        line-height: 50px; /*글자를 감싸는 박스의 높이와 같게 설정*/
        text-align: center;
    }
</style>
</head>
...
<script>
	...
	var msg = "<%=alertMsg%>"; // 성공적으로 로그인되었습니다 / null
	
	if(msg != "null") {
		alert(msg);
		
		// 알람메시지 한 번 띄웠으면 지워주기. 지우지 않으면 매번 menubar.jsp가 열릴 때마다 알람 뜸
...
<div class="nav-area" align="center">
	...
	<%if(loginUser!=null && loginUser.getUserId().equals("admin")) {%>
		<div class="menu"><a href="" style="color:yellow">관리자용1</a></div>
		<div class="menu"><a href="" style="color:yellow">관리자용2</a></div>
	<%} %>
</div>
